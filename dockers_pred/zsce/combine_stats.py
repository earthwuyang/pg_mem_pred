...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='/home/wuy/DB/pg_mem_data/my_postgres_1', help='path to data directory')
    ...
    logger.info(f"Combined statistics: {combined_stats}")