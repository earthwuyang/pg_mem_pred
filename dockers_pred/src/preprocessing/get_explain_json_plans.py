...
from database_list import full_database_list as database_list
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--dataset', nargs='+', help='dataset names', type=str)
    argparser.add_argument('--data_dir', help='data directory', type=str, default=data_dir)
    args = argparser.parse_args()

    if args.dataset == None:
        args.dataset = database_list
