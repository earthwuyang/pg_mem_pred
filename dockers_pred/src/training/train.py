...
def train_model(logger, args, statistics):
    ...
    if args.model.startswith('Hetero'):
        ...
        num_operator_features = 21 # sample_graph.x_dict['operator'].shape[1]
    ...
    #     if isinstance(module, torch.nn.Sequential):  # Check if it's Sequential
    #         print(f"Sequential inside {name}:")
