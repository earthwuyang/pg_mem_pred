...
# new_model_order.append(models[5])
# new_model_order.append(models[3])
...
plt.ylim(1.0, 1.7)  # Set y-axis range
...
plt.legend(title='Models', bbox_to_anchor=(0.98, 0.98), loc='upper right', fontsize=12, title_fontsize=14)
plt.tight_layout()
