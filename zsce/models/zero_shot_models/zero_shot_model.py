...
class ZeroShotModel(FcOutModel):
    ...
    def forward(self, input):
        ...
        """
        graph, features = input  # graph is dgl.heterograph, features has keys: ['column', 'table', 'output_column', 'filter_column', 'plan0', 'plan1', 'plan2', 'plan3', 'plan4', 'plan5', 'plan6', 'plan7', 'plan8', 'plan9', 'plan10', 'plan11', 'plan12', 'plan13', 'logical_pred_0', 'logical_pred_1']
        # graph is dgl.graph
        # ['column', 'table', 'output_column', 'filter_column', 'plan0', 'plan1', 'plan2', 'plan3', 'plan4', 'plan5', 'plan6', 'plan7', 'plan8', 'plan9', 'plan10', 'plan11', 'plan12', 'plan13', 'logical_pred_0', 'logical_pred_1']
