...
statistics_file = 'tpcds_data/statistics_workload_combined.json'
target_dir = 'evaluation_tpcds'
filename_model = 'tpcds'
...
workload_runs = 'tpcds_data/train_plans.json'
test_workload_runs = 'tpcds_data/val_plans.json'

logfilepath = os.path.join('./logs_tpcds/')
