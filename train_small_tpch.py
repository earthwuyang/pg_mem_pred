...
def train_model(logger, workload_runs, test_workload_runs, statistics_file,
                target_dir,
                filename_model,
...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset", type=str, help="Dataset to use for training", default='tpch')
    args = parser.parse_args()
    dataset = args.dataset
    statistics_file = f'{dataset}_data/statistics_workload_combined.json'
    target_dir = f'evaluation_{dataset}'
    filename_model = 'tpch'
    ...
    workload_runs = f'{dataset}_data/train_plans.json'
    test_workload_runs = f'{dataset}_data/val_plans.json'

    logfilepath = os.path.join(f'./logs_{dataset}/')
