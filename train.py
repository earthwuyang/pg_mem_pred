...
statistics_file = 'tpch_data_bk2/statistics_workload_combined.json'
...
workload_runs = 'tpch_data_bk2/parsed_plan.json'
test_workload_runs = 'tpch_data_bk2/parsed_plan.json'
