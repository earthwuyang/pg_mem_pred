...
def get_result(sql, include_column_names=False, db_created=True):
...
def collect_db_statistics():
    ...
    """
    column_stats_names, column_stats_rows = get_result(stats_query, include_column_names=True)
    ...
    """
    table_stats_names, table_stats_rows = get_result(table_stats_query, include_column_names=True)
